...
if st.button("Calculate Metrics"):
    ...
    fig, ax = plt.subplots()
    ax.bar(df1['Metric'], df1['Value'], color='teal')
    ...
    st.markdown("Visit my [LinkedIn](http://linkedin.com/in/joseph-panford-7a51322b1) or contact me (0598912169) for feedback!")
